...
function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className={`transition-[padding] duration-200 ${open ? "pl-60" : "pl-16"}`}>
        <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b bg-background/85 px-4 backdrop-blur sm:px-6">
          <Button variant="ghost" size="icon" onClick={toggle} aria-label="Toggle sidebar"><PanelLeft className="size-5" /></Button>
