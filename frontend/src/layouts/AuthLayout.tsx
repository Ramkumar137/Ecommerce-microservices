  ...
  return (
    <div className="grid min-h-screen bg-background lg:grid-cols-2">
      <div className="flex flex-col px-6 py-10 sm:px-10">
        ...
        {/* <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} HeisenFlow, Inc.</p> */}
      </div>
      <div className="relative hidden overflow-hidden bg-surface lg:block">
        ...
        {/* <div className="absolute bottom-10 left-10 right-10 rounded-xl border border-white/20 bg-background/85 p-6 backdrop-blur">
          <p className="text-sm font-medium">"HeisenFlow has been my go-to for thoughtful, dependable gear. The shopping experience feels genuinely considered."</p>
