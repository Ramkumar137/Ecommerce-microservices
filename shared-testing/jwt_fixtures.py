# shared-testing/jwt_fixtures.py

import jwt
from datetime import datetime, timezone, timedelta

TEST_SECRET_KEY = "test-secret-key-1234567890-test-secret-key"
TEST_ALGORITHM = "HS256"


def create_test_jwt(user_id="usr-123", email="user@example.com", role="CUSTOMER", expires_in_seconds=3600, secret_key=TEST_SECRET_KEY):
...
def create_expired_jwt(user_id="usr-123", email="user@example.com", role="CUSTOMER"):
